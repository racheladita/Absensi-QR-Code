...
<?php
	if(isset($_POST['simpan']))
	{
		...
		{
			mysqli_query($conn, "Insert into dosen values ('".$_POST['nid']."','".$_POST['nama']."','".$_POST['umur']."','')");
			echo "<script>alert('Berhasil ditambahkan')</script>";
			echo "<script>window.location='?cat=akademik&page=dosen'</script>";
		}
		$q = mysqli_query($conn, "Insert into dosen values ('".$_POST['nid']."','".$_POST['nama']."','".$_POST['umur']."','".$namabaru."')");
		if($q)
		{
			echo "<script>alert('Berhasil ditambahkan')</script>";
			echo "<script>window.location='?cat=akademik&page=dosen'</script>";
